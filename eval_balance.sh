...
# ===================================
# Balance Training 모델 평가 스크립트 (파라미터 버전)
# [사용법] bash eval_balance.sh <dataset_name> <gpu_id> <results_dir> <model_path> <config_file>
# 예시: bash eval_balance.sh itw MIG-xxx /path/to/results /path/to/model.pth /path/to/config.yaml
# ===================================
...
# ========================
if [ $# -ne 5 ]; then
  echo "❌ Usage: bash eval_balance.sh <dataset_name> <gpu_id> <results_dir> <model_path> <config_file>"
  echo "예: bash eval_balance.sh itw MIG-57de94a5-be15-5b5a-b67e-e118352d8a59 /home/woongjae/wildspoof/SFM-ADD/results/balance /home/woongjae/wildspoof/SFM-ADD/out/conformertcm_balance_22.pth /home/woongjae/wildspoof/SFM-ADD/configs/conformertcm_balance.yaml"
  echo ""
...
echo "=========================================="
echo "🚀 Balance Training Model Evaluation"
echo "=========================================="
