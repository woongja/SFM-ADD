...
from .white_noise import WhiteNoiseAugmentor
from .pink_noise import PinkNoiseAugmentor
...
#                         'time_stretch', 'highpass_filter', 'autotune', 'echo', 'amplitude_modulation', 'copy_paste', 'white_noise', 'pink_noise']

SUPPORTED_AUGMENTORS = ['background_noise', 'pitch', 'reverb', 'gaussian_noise', 'bandpass',
                        'time_stretch', 'highpass_filter', 'autotune', 'echo', 'white_noise', 'pink_noise']
