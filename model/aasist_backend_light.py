...
class AASIST_Backend(nn.Module):
    def __init__(self, input_dim=1024):
        ...
        filts = [64, [1, 16], [16, 16], [16, 32], [32, 32]]
        gat_dims = [32, 16]
        pool_ratios = [0.5, 0.5, 0.5, 0.5]
        temperatures = [2.0, 2.0, 100.0, 100.0]

        # XLS-R embedding → 128차원
        self.LL = nn.Linear(input_dim, 128)

        self.first_bn = nn.BatchNorm2d(num_features=1)
        self.first_bn1 = nn.BatchNorm2d(num_features=32)
    ...
    def forward(self, x_emb):  # [B, T, 1024]
        ...
        out_T1, out_S1, master1 = out_T1+out_T_aug, out_S1+out_S_aug, master1+master_aug
        ...
        out_T2, out_S2, master2 = out_T2+out_T_aug, out_S2+out_S_aug, master2+master_aug
